...
float relative ≤1e-9), and 3 of the 4 melee `maxHit` rows RUN and PASS exactly
(osmumtens-fang 50, dragon-hunter-lance 58, obsidian 46). The 2 magic `maxHit`
...
exactly 11 rows run and 3 skip. The remaining `*Calc` / `HitDist` / `scaling/*` /
